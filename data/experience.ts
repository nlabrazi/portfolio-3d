...
export const experiences: ExperienceItem[] = [
  ...
  },
  {
    ...
    stack: ["JIRA, Zendesk", "Grafana, Kibana, Datadog, NewRelic", "Ruby, Javascript, PostgreSQL"]
  },
  {
    company: "Domino’s",
    ...
    summary:
      "Franchise internationale de restauration rapide (pizza).",
    tasks: [
      "Résolution incidents (niveau 3)",
    ...
    stack: ["ETL / Web-App / Web-Server (Aws / Azure)", "NewRelic, Active Directory, Exchange...", "SQL Server 2016"]
  },
  {
    company: "Domino’s",
    companyUrl: "https://www.dominos.fr/",
    ...
    stack: ["Active Directory, Exchange...", "BlackBerry Server", "SQL Server 2012"]
  }
]
